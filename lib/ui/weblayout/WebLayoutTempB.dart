...
class WebLayoutTempB extends StatefulWidget {
   final String title;
   
   WebLayoutTempB({Key key, this.title}) : super(key: key);
   
   @override
   _WebLayoutCenteringBStateB createState() => _WebLayoutCenteringBStateB();
}

class _WebLayoutCenteringBStateB extends State<WebLayoutTempB> {
   @override
   ...
   void onHeightFactorChanged(num value) => setState(() => height_factor = value as double);
   
   void onWidthFactorChanged(num value) => setState(() => width_factor = value as double);
