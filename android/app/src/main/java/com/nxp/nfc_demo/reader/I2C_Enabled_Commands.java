...
public abstract class I2C_Enabled_Commands {
   ...
   public static I2C_Enabled_Commands get(Tag tag) throws IOException, InterruptedException {
      ...
      try {
         ...
         SharedCodes.Companion.log("I2C_CMD", "product: " + prod.toString());
         nfca.close();
      ...
      if (!SharedCodes.Companion.getMiniNtagOnly()){
         nfca.setTimeout(20);
         // check for timeout
         if (nfca.getTimeout() < 50) {
            // check if GetVersion is supported
            SharedCodes.Companion.log("I2C_CMD", "pass timeout");
            try {
               nfca.connect();
               command = new byte[1];
               command[0] = (byte) 0x60; // GET_VERSION
    ...
    *
    * @param off Offset of the Config Register
    * @return Register
    * @throws IOException
    * @throws FormatException
    * @throws CommandNotSupportedException
    ...
    *
    * @param off Offset of the Session Register
    * @return Register
    * @throws IOException
    * @throws FormatException
    * @throws CommandNotSupportedException
   ...
   public abstract void writeEEPROMCustomBytes(byte[] data, byte startAt) throws IOException,
           FormatException, CommandNotSupportedException;
    ...
    * @throws CommandNotSupportedException
    */
   public abstract void writeEEPROMCustom(byte[] data, WriteEEPROMListener listener) throws IOException,
           FormatException, CommandNotSupportedException;
    ...
    *
    * @param data      Raw Data to write
    * @param startAddr Start Address from which the write begins
    * @throws IOException
    * @throws FormatException
    */
    ...
    *
    * @param absStart Start of the read
    * @param absEnd   End of the read(included in the Answer)
    * @return Data read
    * @throws IOException
    * @throws FormatException
    * @throws CommandNotSupportedException
    ...
    * @throws CommandNotSupportedException
    */
   public abstract byte[] readEEPROMCustom(int absStart, int absEnd)
           throws IOException, FormatException, CommandNotSupportedException;


   public abstract byte[] readEEPROMCustomBytes(int absStart, int absEnd)
           throws IOException, FormatException, CommandNotSupportedException;
    ...
    * @param method Method with which the SRAM is read
    ...
    * detection routine.
    *
    * @param message NDEF message to write on the tag
    * @throws IOException
    * @throws FormatException
    * @throws CommandNotSupportedException
    */
    ...
    * @throws CommandNotSupportedException
    */
   public abstract void writeNDEFCustom(NdefMessage message, WriteEEPROMListener listener) throws IOException,
           FormatException, CommandNotSupportedException;

   /**
    * Authenticate using PWD_AUTH command against NTAG I2C Plus product.
    *
    * @param pwd 4Byte password to authenticate with
    * @throws IOException
    ...
    *
    * @param pwd        4Byte password to authenticate with
    * @param staretAddr Page to lock the memory from
    * @throws IOException
    * @throws FormatException
    */
   ...
   /**
    * Gets NTAG I2C Plus PT_I2C Register. (PT abbreviate for Pass Thru)
    *
    ...
    * @throws CommandNotSupportedException
    */
   public abstract NtagRawRecord readNDEFCustom() throws IOException, FormatException, CommandNotSupportedException;
